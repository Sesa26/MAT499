<template>
	<div class="container-fluid">
		<p class="white-text h2 blue darken-3 ">Carboxylic Acid</p>
	...
	methods: {
		...
		convertFromMoleculaFormula() {
			...
			if (this.carbon == 0) {
				...
				this.name = "methanoic acid";
			} else if (this.carbon == 2) {
				this.name = "ethanoic acid";
			} else if (this.carbon == 3) {
				this.name = "propanoic acid";
			} else if (this.carbon == 4) {
				this.name = "butanoic acid";
			} else if (this.carbon == 5) {
				this.name = "pentanoic acid";
			} else if (this.carbon == 6) {
				this.name = "hexanoic acid";
			} else if (this.carbon == 7) {
				this.name = "heptanoic acid";
			} else if (this.carbon == 8) {
				this.name = "octanoic acid";
			} else if (this.carbon == 9) {
				this.name = "nonanoic acid";
			} else if (this.carbon == 10) {
				this.name = "decanoic acid";
			}
		},
		carbonChange() {
